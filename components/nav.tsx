      ...
      <div className="flex-1 items-center hidden md:flex">
        ...
        <Link href="/">
          <p className="ml-3 text-sm">
            model <span className="font-bold">playground</span>
          </p>
        </Link>
        <Link
        ...
        >
          <p className="cursor-pointer text-sm ml-5 text-muted-foreground hover:text-foreground">
            models
          </p>
        </Link>
        <Link
        ...
        <Link
          href="https://github.com/fal-ai/realtime-birefnet"
          target="_blank"
          rel="noopener noreferrer"
        >
